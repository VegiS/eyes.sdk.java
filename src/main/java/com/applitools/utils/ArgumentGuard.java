...
public class ArgumentGuard {
     ...
     * @param paramName The input parameter name.
     */
    public static void greaterThanOrEqualToZero(int param, String paramName)
            throws IllegalArgumentException {
        if (0 > param) {
     ...
     * @param paramName The input parameter name.
     */
    public static void greaterThanZero(int param, String paramName)
            throws IllegalArgumentException {
        if (0 >= param) {
     ...
     */
    @SuppressWarnings("UnusedDeclaration")
    public static void notZero(int param, String paramName)
            throws IllegalArgumentException {
        if (0 == param) {
            throw new IllegalArgumentException(paramName + " == 0");
        }
